...
export const ONBOARDING_SCREENS: Screen[] = ['welcome', 'path-selection', 'parent-journey-intro', 'parent-onboarding-placeholder', 'onboarding', 'diagnosis', 'diagnosis-result'];
