...
export const FIRST_MELODIES_LESSONS: Lesson[] = [
  ...
  },
  {
    id: 'm8',
    order: 8,
    title: 'Envía tu primer desafío',
    experientialTitle: 'Envía tu primer desafío',
    subtitle: 'Ha llegado el momento de compartir tus primeros acordes. No buscamos perfección, buscamos acompañarte.',
    type: 'Desafío',
    estimatedTime: '5 min',
    kind: 'community',
    description: 'Graba un video corto tocando el ejercicio de esta isla y envíalo al profesor por WhatsApp para recibir feedback personalizado.',
    objective: 'Iniciar la relación con tu profesor enviando tu primer desafío musical.',
    microVictory: 'Diste el primer paso hacia el feedback personalizado.',
    antiFrustrationCopy: 'No importa si aún cometes errores: lo importante es atreverte a compartir.',
  },
  {
    id: 'm10',
    order: 10,
