...
export const START_PORT_NODES: RouteNode[] = [
  ...
  { id: 'n4', title: 'Historia del Ukelele', subtitle: 'Conoce el viaje de este pequeño instrumento.', icon: '🌺', status: 'locked', type: 'Video', time: '3 min' },
  { id: 'n5', title: 'Partes del Ukelele', subtitle: 'Conoce las partes de tu compañero musical.', icon: '🎸', status: 'locked', type: 'Video', time: '3 min' },
