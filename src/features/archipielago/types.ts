export type Screen = 'welcome' | 'onboarding' | 'diagnosis' | 'diagnosis-result' | 'route' | 'mission' | 'mission-guide' | 'mission-two' | 'mission-three' | 'mission-four' | 'mission-six' | 'mission-seven' | 'mission-eight' | 'mission-nine' | 'first-melodies-island' | 'first-melodies-lesson' | 'pulse-island' | 'pulse-lesson' | 'rhythm-island' | 'rhythm-lesson' | 'music-island' | 'celebration';
