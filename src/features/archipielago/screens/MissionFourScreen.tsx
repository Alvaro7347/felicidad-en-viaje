  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <MissionIntroHeader
        ...
        subtitle="Descubre el viaje del ukelele y conoce las partes de tu compañero musical."
      />
      ...
      <Card style={{ padding: 0, overflow: "hidden" }}>
        <div style={{ position: "relative", height: 220, background: "#111" }}>
          <img
            src={VIDEO_THUMB}
            alt="Historia y partes del ukelele"
          ...
          <div style={{ position: "absolute", left: 14, right: 14, bottom: 14, color: B.white }}>
            ...
            <div style={{ fontWeight: 800, fontSize: 15, textShadow: "0 1px 4px rgba(0,0,0,0.5)" }}>
              El viaje y la anatomía del ukelele
            </div>
            <div style={{ fontSize: 12, opacity: 0.92, marginTop: 2, textShadow: "0 1px 4px rgba(0,0,0,0.5)" }}>
              Conoce de dónde viene y aprende a reconocer sus partes principales.
            </div>
          </div>
          <button
            type="button"
            aria-label="Reproducir video de historia y partes del ukelele"
      ...
      <Card>
        <p style={{ margin: 0, color: "#666", lineHeight: 1.7, fontSize: 13 }}>
          En esta clase descubrirás de dónde viene el ukelele y aprenderás a reconocer las partes principales que utilizarás durante todo tu viaje musical.
        </p>
      </Card>
      ...
      <Card>
        ...
        <div style={{ display: "grid", gap: 10, fontSize: 13, lineHeight: 1.6, color: "#666" }}>
          ...
          <div>🌺 Cómo se integró en la cultura hawaiana y llegó al mundo.</div>
          <div>🎸 Qué son el cuerpo, el mástil y el clavijero.</div>
          <div>🎼 Para qué sirven las cuerdas, los trastes y las clavijas.</div>
        </div>
      </Card>
      ...
      <Card>
        ...
        <div style={{ display: "grid", gap: 10, fontSize: 13, lineHeight: 1.6, color: "#666" }}>
          ...
          <div><strong style={{ color: B.dark }}>Trastes:</strong> divisiones que te ayudan a encontrar sonidos.</div>
          <div><strong style={{ color: B.dark }}>Clavijas:</strong> sirven para afinar las cuerdas.</div>
          <div><strong style={{ color: B.dark }}>Cuerdas:</strong> vibran para producir el sonido.</div>
        </div>
      </Card>

      <Card style={{ background: B.greenLight }}>
        <p style={{ margin: 0, color: B.dark, lineHeight: 1.7, fontSize: 13 }}>
          Conocer la historia y las partes de tu ukelele es el primer paso para sentirlo cercano. Desde ahora ya no tienes solo un instrumento: tienes un compañero de viaje.
        </p>
      </Card>
            ...
            <div style={{ padding: "10px 14px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, flexShrink: 0 }}>
              <div style={{ minWidth: 0 }}>
                ...
                <div style={{ fontSize: 11, color: "#666", marginTop: 2, lineHeight: 1.2, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                  El viaje y la anatomía de tu compañero musical.
                </div>
              </div>
              <button
                type="button"
