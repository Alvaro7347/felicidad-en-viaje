...
const STRUMMING_NODES: RouteNode[] = [
  { id: 'strumming1',  title: 'Aprende el apagado',                              subtitle: 'Descubre cómo silenciar las cuerdas para darle intención al ritmo.', icon: '🤫', status: 'current', type: 'Video práctica', time: '5 min' },
  { id: 'strumming2',  title: 'Toca Despacito de Luis Fonsi',                     subtitle: 'Aplica ritmo y acordes en una canción reconocible.',                icon: '🎵', status: 'locked',  type: 'Canción guiada', time: '6 min' },
  { id: 'strumming3',  title: 'Toca Corazón de Los Auténticos Decadentes',        subtitle: 'Practica una canción energética con rasgueo constante.',            icon: '❤️', status: 'locked',  type: 'Canción guiada', time: '6 min' },
  { id: 'strumming4',  title: 'Aprende rasgueo de Balada 1',                      subtitle: 'Incorpora un patrón suave para canciones lentas.',                  icon: '🌙', status: 'locked',  type: 'Video práctica', time: '5 min' },
  { id: 'strumming5',  title: 'Toca Creep de Radiohead',                          subtitle: 'Usa el rasgueo de balada en una canción intensa.',                  icon: '🎸', status: 'locked',  type: 'Canción guiada', time: '6 min' },
  { id: 'strumming6',  title: 'Toca One de U2',                                   subtitle: 'Practica una canción emocional sosteniendo el pulso.',              icon: '🎤', status: 'locked',  type: 'Canción guiada', time: '6 min' },
  { id: 'strumming7',  title: 'Toca The Reason de Hoobastank',                    subtitle: 'Aplica rasgueo y cambios en una balada moderna.',                   icon: '🎶', status: 'locked',  type: 'Canción guiada', time: '6 min' },
  { id: 'strumming8',  title: 'Aprende rasgueo de Balada 2',                      subtitle: 'Suma una nueva variación para acompañamientos suaves.',             icon: '🌊', status: 'locked',  type: 'Video práctica', time: '5 min' },
  { id: 'strumming9',  title: 'Toca Miénteme una vez de Los Vásquez',             subtitle: 'Practica una canción popular con rasgueo de balada.',               icon: '🎵', status: 'locked',  type: 'Canción guiada', time: '6 min' },
  { id: 'strumming10', title: 'Toca A Thousand Years de Christina Perri',         subtitle: 'Acompaña una canción lenta cuidando emoción y ritmo.',              icon: '💫', status: 'locked',  type: 'Canción guiada', time: '6 min' },
  { id: 'strumming11', title: 'Toca Mi eterno amor secreto',                      subtitle: 'Cierra la isla aplicando tus rasgueos de balada.',                  icon: '🏆', status: 'locked',  type: 'Cierre de isla', time: '6 min' },
];
...
const TERRITORIES = [
  ...
  { id: 'rasgueo',           title: 'Isla del Rasgueo',           state: 'active' as const, progress: 0 },
  { id: 'canciones',         title: 'Isla de las Canciones',      state: 'prototype' as const },
];

export function StrummingIslandScreen({
  onOpenStartPort,
  ...
  const [focusedStageId, setFocusedStageId] = useState<string>('rasgueo');
  ...
  useEffect(() => {
    const el = stageRefs.current['rasgueo'];
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginTop: 4, marginBottom: 6 }}>
        ...
        <span style={{ fontFamily: 'Space Grotesk, sans-serif', fontWeight: 800, fontSize: 15, color: B.dark, letterSpacing: '-0.01em' }}>
          Navegante, esta es tu ruta del rasgueo
        </span>
      </div>
